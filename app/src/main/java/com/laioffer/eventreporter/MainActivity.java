...
// register any account, and check the firebase console to verify it is successfully registered.
       ...
       // ListView eventListView = (ListView) findViewById(R.id.event_list);
        ...
        //    Fragment fragment = isTablet() ? new  CommentFragment() : (Fragment) new EventFragment();
   ...
   // }
    ...
    @Override
    public void onItemSelectedReverse(int position) {
